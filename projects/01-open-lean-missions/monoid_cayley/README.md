# 📜 Monoid Cayley (Lean 4 Formalization)

Standalone, machine-checked Lean 4 formalization of **Monoid Cayley** proved from first principles with **0 `sorry`** declarations.
...
- `theorem cayleyFun_one`
- `theorem cayleyFun_mul`
- `theorem cayleyHom_injective`
